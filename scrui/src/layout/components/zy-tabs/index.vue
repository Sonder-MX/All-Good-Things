<template>
  <section class="zy-tabs" id="zy-tab">
    ...
    <a-tooltip placement="topLeft">
      ...
      <IconFont
        class="close-tab close-tab-all"
        @click="handleTabCleanDirection('all')"
        type="icon-guanbi" />
    </a-tooltip>
    <a-dropdown class="close-tab" placement="bottom">
      ...
      <template #overlay>
        <a-menu>
          <a-menu-item @click="handleTabCleanDirection('left')"> 关闭左侧 </a-menu-item>
          <a-menu-item @click="handleTabCleanDirection('right')"> 关闭右侧 </a-menu-item>
          <a-menu-item @click="handleTabCleanDirection('other')"> 关闭其他 </a-menu-item>
          <a-menu-item @click="handleTabCleanDirection('all')"> 关闭全部 </a-menu-item>
        </a-menu>
      </template>
    </a-dropdown>
  </section>
